...
pub use crate::{
    ais::{ai::ToAI, test_ai::test_ai},
    tools::vector_tools::{ToCorrectAmount, ToVectorOfVector},
};
...
pub fn run() {
    ...
    let test_data_first = vec![vec![18.2, 17.2], vec![19.3, 18.2], vec![16.4, 12.2]];
    ...
    println!(
        "{:#?}",
        test_ai(ai, test_data_first, test_data_second, true)
    );
}
